...
class KeyboardViewController: UIInputViewController {
    ...
    var bannerHeight = metric("topBanner")
    
    var bannerExpandedheight = CGFloat(145)
    
    var textInputDelagate:UITextDocumentProxy?
    var hasReference:Bool = false
    ...
    */
    ...
    override func viewDidLayoutSubviews() {
        ...
        self.bannerView?.frame = CGRect(x: 0, y: 0, width: self.view.bounds.width, height: bannerHeight)
    ...
    */
    ...
    func expandHeight() {
        ...
        let _expandedHeight = UIScreen.main.bounds.height / 2 + 30 // this is the height you want your keyboard to be
        self.heightConstraint?.constant =   self.heightConstraint!.constant + 99
        
    }
    
    @objc func newHeight() {
        let _expandedHeight = UIScreen.main.bounds.height / 2 // this is the height you want your keyboard to be

        var frame = self.bannerView?.frame
        frame?.size.height = bannerExpandedheight;
        bannerHeight = bannerExpandedheight
    ...
    func defaultHeight() {
        ...
        bannerHeight = metric("topBanner")
        self.bannerView?.frame = frame!
        self.heightConstraint?.constant =   self.height(forOrientation: self.interfaceOrientation, withTopBanner: true)
    }
...
//extension KeyboardViewController:UITextInputDelegate{
//
//
//
//}

class HeadeView:ExtraView {
